...
def ask_chatbot(query, chat_history=None):
    ...
    # Build system prompt
    system_prompt = (
        f"You are DURGA's personal AI assistant. "
        f"Your job is to help users learn about DURGA's background, "
        ...
        f"Use the provided excerpts as your primary source of truth for factual information about DURGA. "
        ...
        f"Answer in third person when talking about DURGA, but you may use natural conversational language "
